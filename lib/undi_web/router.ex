defmodule UndiWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {UndiWeb.LayoutView, :root}
  ...
  pipeline :api_authenticated do
    plug UndiWeb.AuthAccessPipeline
  end

  pipeline :graphql do
    plug UndiWeb.Context
  end

  scope "/api" do
    pipe_through :graphql

    forward "/", Absinthe.Plug, schema: UndiWeb.Schema
  end
  ...
  if Mix.env == :dev do
    forward "/graphiql", Absinthe.Plug.GraphiQL, schema: UndiWeb.Schema
  end
end
